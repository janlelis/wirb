...
Supported Rubies: 2.2, 2.1, 2.0, 1.9, 1.8, jruby, rubinius
...
All values returned by IRB will be syntax highlighted!

=== <tt>wp</tt>

As an bonus you can also colorize any other object using <tt>wp</tt>:
...
The following schemas are bundled. You can load one with <tt>Wirb.load_schema :name</tt>
...
* Terminal colors: Paint[https://github.com/janlelis/paint]
